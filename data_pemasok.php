            ...
            ?>
              <tr>
                ...
                <td class="text-center">
                  ...
                  <a href="#" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#deleteModal" onclick='deleteModal(`hapus_pemasok.php?id=<?= $data["id"] ?>`, `Komoditas: [<?= $data["kode"] ?>] <?= $data["nama"] ?>`)'>
  ...
  <div class="modal-dialog" role="document">
    ...
    <form action="tambah_pemasok.php" method="POST" id="form" class="modal-content">
      <div class="modal-header bg-success">
        <h5 class="modal-title text-light" id="formModalLabel">Tambah Data Pemasok</h5>
      ...
      <div class="modal-footer">
        <!-- ubah tombol form -->
        <button class="btn btn-secondary" type="reset" data-dismiss="modal" onclick="resetForm('tambah_pemasok.php', 'Tambah Data Pemasok')">Cancel</button>
...
<script>
  ...
  function editForm(data) {
    ...
    let editAction = 'update_pemasok.php';
    // console.log(window.location);
    $('#form').attr('action', editAction);

    // ubah judul form
    $('#formModalLabel').html('Edit Data Pemasok');
