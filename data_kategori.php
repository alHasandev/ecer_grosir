            ...
            ?>
              <tr>
                ...
                <td class="text-center">
                  ...
                  <a href="#" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#deleteModal" onclick='deleteModal(`hapus_kategori.php?id=<?= $data["id"] ?>`, `Kategori: <?= $data["nama"] ?>`)'>
  ...
  <div class="modal-dialog" role="document">
    ...
    <form action="tambah_kategori.php" method="POST" id="form" class="modal-content">
      <div class="modal-header bg-success" style="background-color: rgb(139,69,19)">
        <h5 class="modal-title text-light" id="formModalLabel">Tambah Data Kategori</h5>
      ...
      <div class="modal-footer">
        <!-- ubah tombol form -->
        <button class="btn btn-secondary" type="reset" data-dismiss="modal" onclick="resetForm('tambah_kategori.php', 'Tambah Data Kategori')">Cancel</button>
